...
export const AwakeSheepWalking = ({ size = 64 }: { size?: number }) => (
  <Svg width={size} height={size} viewBox="0 0 64 64" fill="none">
    ...
    {/* Hooves (Moved for walking effect) */}
    {/* Frame 2: Legs 1 & 3 move forward, 2 & 4 move backward slightly */}
    <Rect x="20" y="50" width="4" height="4" fill="#C8B888" />
    <Rect x="26" y="50" width="4" height="4" fill="#C8B888" />
    <Rect x="38" y="50" width="4" height="4" fill="#C8B888" />
