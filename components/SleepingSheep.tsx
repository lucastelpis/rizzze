...
export const SleepingSheep = ({ size = 64 }: { size?: number }) => (
  <Svg width={size} height={size} viewBox="0 0 64 64" fill="none">
    ...
    {/* Zzz */}
    <SvgText x="48" y="22" fontSize="6" fill="#8B6DAE" fontWeight="bold" fontFamily="monospace">z</SvgText>
    <SvgText x="52" y="18" fontSize="5" fill="#C4AED8" fontWeight="bold" fontFamily="monospace">z</SvgText>
    <SvgText x="55" y="14" fontSize="4" fill="#EDE5F5" fontWeight="bold" fontFamily="monospace">z</SvgText>
  </Svg>
);
